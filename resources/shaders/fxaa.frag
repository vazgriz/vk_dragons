...
void main(){	
	...
	float stepLength = isHorizontal ? camUniforms.inverseScreenSize.y : camUniforms.inverseScreenSize.x;
	...
	vec2 offset = isHorizontal ? vec2(camUniforms.inverseScreenSize.x,0.0) : vec2(0.0,camUniforms.inverseScreenSize.y);
